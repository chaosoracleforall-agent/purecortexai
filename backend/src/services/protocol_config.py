...
PROTOCOL_CONFIG: Final[dict[str, Any]] = {'name': 'PURECORTEX',
 ...
 'contracts': {'agentFactory': {'appId': 3501164435,
               ...
               'airdropClaim': {'appId': 3502246857, 'status': 'active'}},
