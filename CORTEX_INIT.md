...
### **Security Protocols**
- **Gas safety:** Max 5 Gwei ceiling on Base network.
- **Egress Filtering:** Restricted to Gemini, Anthropic, Moltbook, and Base RPC endpoints.
- **Reporting:** SMTP authenticated via Gmail App Passwords.
