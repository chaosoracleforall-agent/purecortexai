...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/airdrop`, lastModified: new Date(), changeFrequency: 'daily', priority: 0.9 },
    ...
    { url: `${baseUrl}/developers/access`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.7 },
