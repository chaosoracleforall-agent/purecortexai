...
%
% Author: David Garcia, PURECORTEX Research
% =============================================================================
...
\input{sections/04-bonding-curve}
\input{sections/05-dynamic-fees}
\input{sections/06-vecortex-staking}
\input{sections/07-buyback-burn}
\input{sections/08-composability}
\input{sections/09-governance}
\input{sections/10-game-theory}
\input{sections/11-simulations}
\input{sections/12-security}
\input{sections/13-comparative}
\input{sections/14-conclusion}

% --- Appendices ---------------------------------------------------------------
\appendix
\input{appendices/appendix-a-proofs}
\input{appendices/appendix-b-simulation}
\input{appendices/appendix-c-contracts}
\input{appendices/appendix-d-constitution}
